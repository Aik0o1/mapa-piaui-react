        ...
        <div className="footer-container flex gap-10 justify-center">
          ...
          <div>
            ...
            <p className="text-sm">
              ...
              CNPJ 06.090.994/0001-00<br />
              Rua General Osório, 3002 - Cabral<br />
              Teresina/PI CEP: 64000-580<br />
              Telefone: (86) 3230-8800<br />
          ...
          <div >
            ...
            <div className="redes space-y-2 flex flex-col gap-3">
              ...
              <a target="_blank" href="https://www.facebook.com/jucepidigital" className="flex items-center gap-2 text-sm hover:text-blue-200">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/></svg>
                Facebook
              </a>
              <a target="_blank" href="https://www.instagram.com/jucepidigital/" className="flex items-center gap-2 text-sm hover:text-blue-200">
              ...
              <a target="_blank" href="https://www.youtube.com/@jucepidigital" className="flex items-center gap-2 text-sm hover:text-blue-200">
